  ...
  <div className="container-fluid">
    <div className="row">
      ...
      <div className="col-lg-5 p-0">
        <div
          className="chooseus__pic"
          style={{
            backgroundImage: "url('/img/chooseus-pic.jpg')",
            width: '100%',
            height: '300%',
            minHeight: '600px',
        ...
        ></div>
            ...
            <div className="col-lg-7 offset-lg-5 p-0">
              <div className="chooseus__text">
                ...
                <ul>
                  <li><span className="icon_check"></span> Lorem ipsum dolor sit amet, consectetur adipiscing elit.</li>
                  <li><span className="icon_check"></span> Integer et nisl et massa tempor ornare vel id orci.</li>
                  <li><span className="icon_check"></span> Nunc consectetur ligula vitae nisl placerat tempus.</li>
                  <li><span className="icon_check"></span> Curabitur quis ante vitae lacus varius pretium.</li>
                </ul>
            ...
            <div className="col-lg-12">
              <div className="testimonial__slider owl-carousel">
                <div className="testimonial__item">
                  ...
                  <p>“A lot of agencies can talk a good game. Don't be fooled, look at the results. This is the only agency that lives up to the hype.”</p>
                </div>
                <div className="testimonial__item">
                  <span className="icon_quotations"></span>
                  <p>“A lot of agencies can talk a good idea. Don't be fooled, look at the results. This is the only agency that lives up to the hype.”</p>
                </div>
                <div className="testimonial__item">
                  <span className="icon_quotations"></span>
                  <p>“A lot of agencies can talk a good option. Don't be fooled, look at the results. This is the only agency that lives up to the hype.”</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="col-lg-3 col-md-4 col-sm-6">
              <div className="counter__item">
                ...
                <div className="counter__item__text">
                  <h2 className="project-counter">560</h2>
                  <strong>+</strong>
                  <p>All Project</p>
                </div>
              </div>
          ...
          <div className="row">
            <div className="col-lg-4 col-md-6">
              <div className="latest__item">
                <div className="latest__item__pic" style={{ backgroundImage: "url('/img/blog/latest-1.jpg')" }}>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="latest__item">
                <div className="latest__item__pic" style={{ backgroundImage: "url('/img/blog/latest-2.jpg')" }}>
                  <p>By <span>Brian Gardner on April 1, 2017</span></p>
                </div>
                <div className="latest__item__text">
                  <h4><a href="#">Benjamin Franlin Method</a></h4>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="latest__item">
                <div className="latest__item__pic" style={{ backgroundImage: "url('/img/blog/latest-3.jpg')" }}>
                  <p>By <span>Brian Gardner on April 1, 2017</span></p>
                </div>
                <div className="latest__item__text">
                  <h4><a href="#">Benjamin Franlin Method</a></h4>
